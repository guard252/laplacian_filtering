...
int main()
{
    ...
    try
    {
        retouch::Image layer_1 = loader.loadPNG("../images/input_images/nature.png");
        ...
        {
            std::string file_path = "../images/output_images/nature_layer_" + std::to_string(current_layer) + ".png";
